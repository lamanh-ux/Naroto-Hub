...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Volamanh Naroto Hub chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "Volamanh Naroto Hub", HidePremium = false, IntroText = "Volamanh Naroto Hub⚜️", SaveConfig = true, ConfigFolder = "NightHub"})



OrionLib:MakeNotification({
    Name = "Volamanh Naroto Hub",
...
W:AddLabel("Volamanh Naroto Hub")
...
W:AddLabel("Volamanh Naroto Hub SCRIPT")
W:AddLabel("DiscordVolamanh Naroto Hub")
local Section = W:AddSection({
    Name = "Status"
})
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Volamanh Naroto Hub(Noitification)",
